...
def solution(arr):
    identical_pairs = len(list(filter(lambda t: arr[t[0]] == arr[t[1]], combinations(range(len(arr)), 2))))
    return (1e9 if identical_pairs > 1e9 else identical_pairs)  # 1e9 == 1,000,000,000
